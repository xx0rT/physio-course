...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center px-5 md:px-10 pt-32 pb-32 md:py-20 md:pb-40 bg-white dark:bg-neutral-900 overflow-visible transition-all duration-700 ease-in-out">
