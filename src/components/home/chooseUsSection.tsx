...
const WhyChooseUsSection = () => {
  ...
  return (
    <section className="relative max-w-7xl mx-auto px-5 md:px-10 py-24 flex flex-col lg:flex-row justify-between items-center gap-16 cursor-default overflow-x-hidden bg-white dark:bg-neutral-900 rounded-3xl my-20 transition-all duration-700 ease-in-out">
