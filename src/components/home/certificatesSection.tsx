  ...
  return (
    <section className="relative w-full py-20 overflow-hidden transition-all duration-700 ease-in-out">
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-10">
        ...
        <div className="relative w-full overflow-hidden bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-sm py-12">
          <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-white/80 dark:from-neutral-800/80 to-transparent z-10"></div>
          <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-white/80 dark:from-neutral-800/80 to-transparent z-10"></div>
