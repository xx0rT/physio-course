...
export default function BentoGrid() {
  return (
    <section className="py-32 transition-all duration-700 ease-in-out">
      <MaxWidthWrapper>
        <div className="relative z-10 grid grid-cols-6 gap-3">
          {/* First card */}
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-8 lg:col-span-2">
            <div className="relative m-auto size-fit">
              <div className="relative flex h-24 w-56 items-center">
                <svg
                  className="absolute inset-0 size-full text-neutral-300 dark:text-neutral-700"
                  viewBox="0 0 254 104"
                  fill="none"
                ...
                <span className="bg-gradient-to-r from-purple-600 via-blue-500 to-teal-400 bg-clip-text text-transparent mx-auto block w-fit text-5xl font-bold">
                  100%
                </span>
              </div>
          ...
          {/* Second card */}
          <div className="relative col-span-full overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-8 sm:col-span-3 lg:col-span-2">
            <div>
              <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-neutral-200 dark:border-neutral-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-neutral-200 dark:before:border-neutral-700 before:bg-neutral-100/20 dark:before:bg-neutral-700/20">
                <svg
          ...
          {/* Community card */}
          <div className="relative col-span-full overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 p-8 lg:col-span-6">
            <div className="grid h-full sm:grid-cols-2 gap-8">
              <div className="relative z-10 flex flex-col justify-center space-y-6">
                <div className="relative flex aspect-square size-12 rounded-full border border-neutral-200 dark:border-neutral-700 before:absolute before:-inset-2 before:rounded-full before:border before:border-neutral-200 dark:before:border-neutral-700 dark:bg-neutral-700/20 before:bg-neutral-100/20 dark:before:bg-neutral-700/20">
                  <svg
              ...
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-purple-500/50 sm:-my-8 sm:-mr-8">
                <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                  <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                    <span className="block h-fit rounded-md border border-neutral-200 dark:border-neutral-700 bg-neutral-100/50 dark:bg-neutral-700/50 px-2 py-1 text-xs">
                      Jan Novák
                    </span>
                    <div className="size-7 ring-4 ring-white dark:ring-neutral-900">
                      <img
                        className="size-full rounded-full border border-neutral-200 dark:border-neutral-700 object-cover"
                  ...
                  <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                    <div className="size-8 ring-4 ring-white dark:ring-neutral-900">
                      <img
                        className="size-full rounded-full border border-neutral-200 dark:border-neutral-700 object-cover"
